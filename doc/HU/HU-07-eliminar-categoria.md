...
## Alcance
Cubre la capacidad 7 de Alcance — Incluye: eliminar una categoría, propia o del catálogo inicial, solo si no tiene movimientos registrados en ningún mes. Mientras los tenga, la eliminación se impide; el usuario puede renombrarla (HU-06). No incluye acceso del usuario a eliminar movimientos de meses anteriores (fuera de alcance).
...
Dado que la categoría "gasolina" no tiene movimientos registrados en ningún mes
...
Dado que la categoría "comida" tiene al menos un movimiento registrado en algún mes
Cuando el usuario solicita eliminarla
...
Dado que una categoría tiene movimientos únicamente en un mes ya cerrado
