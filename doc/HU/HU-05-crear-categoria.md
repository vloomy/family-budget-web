...
## Alcance
Cubre la capacidad 5 de Alcance — Incluye: crear una categoría propia, declarando al crearla si es de gasto o de ingreso. El tipo determina en qué total del resumen participan sus movimientos. No incluye renombrar ni eliminar.
...
- Persistencia local; moneda S/; español.

## Criterios de aceptación (Gherkin)

### Escenario: Camino feliz — crear categoría de gasto
Dado que el usuario está gestionando categorías
...
Dado que el usuario está creando una categoría
