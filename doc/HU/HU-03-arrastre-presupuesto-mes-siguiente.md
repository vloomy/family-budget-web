...
- Persistencia local; moneda S/; ciclo mensual fijo.

## Criterios de aceptación (Gherkin)

### Escenario: Camino feliz — presupuestos se mantienen al cambiar de mes
Dado que en el mes anterior la categoría "comida" tenía un presupuesto de S/ 500
...
Dado que en el mes anterior la categoría "comida" tenía presupuesto S/ 500
...
## Validación INVEST
- Independiente: complementa la definición de presupuesto (HU-02) como comportamiento de transición de mes; se puede probar aislada con datos de mes previo en almacenamiento local.
