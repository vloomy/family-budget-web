...
## Alcance
Cubre la capacidad 4 de Alcance — Incluye: consultar el catálogo vigente, incluidas las creadas por el usuario y las que no tienen presupuesto ni movimientos en el mes. No incluye crear, renombrar ni eliminar (HUs 05–07).
...
- Idioma: español. Persistencia local.

## Criterios de aceptación (Gherkin)

### Escenario: Camino feliz — ver catálogo con tipos
Dado que la app tiene el catálogo inicial de 13 categorías
...
Dado que el usuario creó una categoría propia "colegio"
